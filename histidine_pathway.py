metabolites_and_info = {'adp_c': {'charge': -3,
                        ...
                        'glu__L_c': {'charge': -1,
                                     ...
                                     'formula': 'C5H8NO4',
                                     'name': 'L-Glutamate'},
                        'h2o_c': {'charge': 0, 'compartment': 'c',
                                  'formula': 'H2O', 'name': 'H2O'},
                        'h_c': {'charge': 1, 'compartment': 'c',
                                'formula': 'H', 'name': 'H+'},
                        'his__L_c': {'charge': 0,
                                     'compartment': 'c',
                                     'formula': 'C6H9N3O2',
...
reactions_and_info = {'ATPPRT': {'lower_bound': 0.0,
                                 'name': 'ATP phosphoribosyltransferase',
                                 'stoichiometry': {'atp_c': -1.0,
                                                   'ppi_c': 1.0,
                                                   'prbatp_c': 1.0,
                                                   'prpp_c': -1.0},
                                 'upper_bound': 1000.0},
                      'HISTD': {'lower_bound': 0.0,
                                'name': 'histidinol dehydrogenase',
                                'stoichiometry': {'h2o_c': -1.0,
                                                  'h_c': 3.0,
                                                  'his__L_c': 1.0,
                                                  'histd_c': -1.0,
                                                  'nad_c': -2.0,
                      ...
                      'IG3PS': {'lower_bound': 0.0,
                                ...
                                'stoichiometry': {'aicar_c': 1.0,
                                                  ...
                                                  'prlp_c': -1.0},
                                'upper_bound': 1000.0},
                      'IGPDH': {'lower_bound': 0.0,
                                'name': 'imidazoleglycerol-phosphate dehydratase',
                                'stoichiometry': {'eig3p_c': -1.0,
                                                  'h2o_c': 1.0,
                                                  'imacp_c': 1.0},
                                'upper_bound': 1000.0},
                      'PRAMPC': {'lower_bound': 0.0,
                                 'name': 'phosphoribosyl-AMP cyclohydrolase',
                                 'stoichiometry': {'h2o_c': -1.0,
                                                   'prbamp_c': -1.0,
                                                   'prfp_c': 1.0},
                                 'upper_bound': 1000.0},
                      'PRATPP': {'lower_bound': 0.0,
